...
The checked-in skills cover planning, slicing and delegation, reporting, evidence-based completion, target-branch handling, workflow feedback, task packages, explanatory HTML pages, modern context revision, and focused frontend/backend/DevOps/visual quality checks. Skills are support material; they do not replace owner responsibility.
